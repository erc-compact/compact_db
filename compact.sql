...
CREATE TABLE `Beam` (
  ...
  `beam_config_id` int(11) DEFAULT NULL,
  `beam_type_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_pointing_id` (`pointing_id`),
  KEY `beam_config_id` (`beam_config_id`),
  KEY `beam_type_id` (`beam_type_id`),
  CONSTRAINT `beam_ibfk_1` FOREIGN KEY (`beam_config_id`) REFERENCES `Beam_config` (`id`),
  CONSTRAINT `beam_ibfk_2` FOREIGN KEY (`beam_type_id`) REFERENCES `BeamTypes` (`id`),
  CONSTRAINT `fk_pointing_id` FOREIGN KEY (`pointing_id`) REFERENCES `Pointing` (`id`)
...
--
-- Table structure for table `Beam_config`
--

DROP TABLE IF EXISTS `Beam_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Beam_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `antennas_used` varchar(255) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `nantennas` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Beam_config`
--

LOCK TABLES `Beam_config` WRITE;
/*!40000 ALTER TABLE `Beam_config` DISABLE KEYS */;
/*!40000 ALTER TABLE `Beam_config` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `target` (
  ...
  PRIMARY KEY (`id`),
  KEY `project_id` (`project_id`),
  CONSTRAINT `target_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`)
...
-- Dump completed on 2023-11-28 14:03:28
