...
CREATE TABLE `circular_orbit_search` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `min_porb_h` decimal(8,6) DEFAULT NULL,
  `max_porb_h` decimal(8,6) DEFAULT NULL,
  `min_pulsar_mass_m0` decimal(3,3) DEFAULT NULL,
  `max_comp_mass_m0` decimal(8,3) DEFAULT NULL,
  `min_orb_phase_rad` decimal(3,3) DEFAULT NULL,
...
CREATE TABLE `data_product` (
  ...
  `tsamp_seconds` decimal(8,8) DEFAULT NULL,
  `tobs_seconds` decimal(8,4) DEFAULT NULL,
  `nsamples` bigint(20) DEFAULT NULL,
  `freq_start_mhz` decimal(6,4) DEFAULT NULL,
  `freq_end_mhz` decimal(6,4) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `elliptical_orbit_search` (
  ...
  `min_orb_phase_rad` decimal(3,3) DEFAULT NULL,
  `max_orb_phase_rad` decimal(3,3) DEFAULT NULL,
  `min_ecc` decimal(3,3) DEFAULT NULL,
  `max_ecc` decimal(3,3) DEFAULT NULL,
  `min_periastron_rad` decimal(3,3) DEFAULT NULL,
...
CREATE TABLE `fold_candidate` (
  ...
  `beam_id` int(11) NOT NULL,
  `processing_id` int(11) NOT NULL,
  `spin_period` decimal(8,6) DEFAULT NULL,
  `dm` decimal(6,4) DEFAULT NULL,
  `acc` decimal(8,4) DEFAULT NULL,
  `jerk` decimal(8,4) DEFAULT NULL,
  `omega` decimal(6,6) DEFAULT NULL,
  `tau` decimal(6,6) DEFAULT NULL,
  `phi` decimal(4,4) DEFAULT NULL,
  `long_periastron` decimal(4,4) DEFAULT NULL,
  `ecc` decimal(3,3) DEFAULT NULL,
  `fold_snr` decimal(8,3) DEFAULT NULL,
  `filename` varchar(255) DEFAULT NULL,
  `filepath` varchar(255) DEFAULT NULL,
...
CREATE TABLE `peasoup` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `acc_start` decimal(8,4) DEFAULT NULL,
  `acc_end` decimal(8,4) DEFAULT NULL,
  `min_snr` decimal(6,4) DEFAULT NULL,
  `ram_limit_gb` decimal(6,4) DEFAULT NULL,
  ...
  `accel_tol` decimal(4,4) DEFAULT NULL,
...
CREATE TABLE `pointing` (
  ...
  `freq_start_mhz` decimal(6,4) DEFAULT NULL,
  `freq_end_mhz` decimal(6,4) DEFAULT NULL,
  `tsamp_raw_seconds` decimal(8,8) DEFAULT NULL,
  `telescope_id` int(11) DEFAULT NULL,
...
CREATE TABLE `processing` (
  ...
  `pipeline_execution_order_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_pr_pipeline_id` (`pipeline_id`),
  KEY `fk_pr_cluster_id` (`hardware_id`),
  KEY `pipeline_execution_order_id` (`pipeline_execution_order_id`),
  ...
  CONSTRAINT `processing_ibfk_1` FOREIGN KEY (`pipeline_execution_order_id`) REFERENCES `pipeline_execution_order` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pulsarx` (
  ...
  `subint_length` decimal(6,3) DEFAULT NULL,
  `clfd_q_value` decimal(4,2) DEFAULT NULL,
...
CREATE TABLE `rfifind` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `time` decimal(3,3) DEFAULT NULL,
  `time_sigma` decimal(3,3) DEFAULT NULL,
  `freq_sigma` decimal(3,3) DEFAULT NULL,
  `chan_frac` decimal(3,3) DEFAULT NULL,
...
CREATE TABLE `search_candidate` (
  ...
  `long_periastron` decimal(4,4) DEFAULT NULL,
  `ecc` decimal(3,3) DEFAULT NULL,
  `snr` decimal(8,3) DEFAULT NULL,
  `ddm_count_ratio` decimal(6,6) DEFAULT NULL,
  `ddm_snr_ratio` decimal(6,6) DEFAULT NULL,
  `nassoc` int(11) DEFAULT NULL,
  `tstart` decimal(6,6) DEFAULT NULL,
  `fft_size` bigint(20) DEFAULT NULL,
  `filename` varchar(255) DEFAULT NULL,
  `filepath` varchar(255) DEFAULT NULL,
